...
export default function OverView() {
  return (
    <div className="flex flex-col w-full ">
      <div className="h-16 border-b border-[#c4c7c5] flex items-center pr-6 ml-[104px]">
        <h2 className="text-[21px] font-medium">Tổng quan</h2>
      </div>
      <div className=" h-[calc(100vh-64px)] w-full ml-[104px] overflow-y-scroll">
        {/* Header */}
        ...
        <div className="w-full max-w-[912px] ml-[101px] mt-6">
          <div className="bg-white rounded-xl px-5 py-4 flex items-center justify-between">
            ...
            <button className="text-[#1a73e8] text-sm font-medium flex items-center gap-1 whitespace-nowrap hover:underline">
              Khám phá thông tin chi tiết dành cho bạn{" "}
                ...
                <div>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="bg-[#fde293] p-2 m-1 rounded-full">
                      <LightbulbOutlinedIcon
                        className="text-[#a06000]"
                        size={20}
                      />
                    </div>
                    <p className="text-s text-black">
                      <span>
                        Một trang gần đây nhận được nhiều lượt hiển thị hơn bình
                        thường
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex items-center gap-4 py-2">
                      <ThumbsUp
                        size={17}
                        className="text-brown-900 cursor-pointer"
                      />
                      <ThumbsDown
                        size={17}
                        className="text-brown-900 cursor-pointer"
            ...
            <div className="mt-4 py-5 flex items-center">
              ...
              <div className="flex items-center gap-3 min-w-[220px] justify-end">
                ...
                <div className="flex flex-col gap-1 items-end">
                  <span
                    aria-hidden
                    className="block w-16 h-[2px] bg-gray-300 rounded"
                  ></span>
                  <span
                    aria-hidden
                    className="block w-16 h-[2px] bg-green-700 rounded"
                  ></span>
                </div>
